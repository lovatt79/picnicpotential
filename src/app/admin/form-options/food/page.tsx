...
export default function FoodPage() {
  ...
  async function handleCreate() {
    await supabase.from("form_food_options").insert(newForm);
    setNewForm({
      label: "",
      price: null,
      price_unit: "per_person",
  ...
  async function handleUpdate(id: string) {
    await supabase.from("form_food_options").update(editForm).eq("id", id);
    setEditingId(null);
    loadItems();
  }
  ...
  async function handleDelete(id: string) {
    ...
    await supabase.from("form_food_options").delete().eq("id", id);
    loadItems();
  }
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h1 className="font-serif text-3xl text-charcoal">Food Options</h1>
        <p className="text-warm-gray mt-1">Manage food options in the service request form</p>
      </div>
      ...
      <div className="mb-6">
        ...
        >
          {showNewForm ? "Cancel" : "+ Add New Food Option"}
        </button>
      </div>
      ...
      {showNewForm && (
        <div className="bg-white rounded-xl p-6 shadow-sm mb-6">
          <h3 className="font-medium text-charcoal mb-4">New Food Option</h3>
