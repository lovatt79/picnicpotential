...
export default function OccasionsPage() {
  ...
  async function handleCreate() {
    await supabase.from("form_occasion_options").insert(newForm);
  ...
  async function handleUpdate(id: string) {
    await supabase.from("form_occasion_options").update(editForm).eq("id", id);
    setEditingId(null);
    loadItems();
  }
  ...
  async function handleDelete(id: string) {
    ...
    await supabase.from("form_occasion_options").delete().eq("id", id);
    loadItems();
  }

  function startEdit(item: Occasion) {
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h1 className="font-serif text-3xl text-charcoal">Occasion Options</h1>
        <p className="text-warm-gray mt-1">Manage occasion options in the service request form</p>
      </div>
      ...
      <div className="mb-6">
        ...
        >
          {showNewForm ? "Cancel" : "+ Add New Occasion"}
        </button>
      </div>
      ...
      {showNewForm && (
        <div className="bg-white rounded-xl p-6 shadow-sm mb-6">
          <h3 className="font-medium text-charcoal mb-4">New Occasion</h3>
