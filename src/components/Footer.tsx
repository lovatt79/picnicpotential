...
import { SITE_NAME, CONTACT_EMAIL, PINTEREST_URL, INSTAGRAM_URL, NAV_LINKS } from "@/lib/constants";
        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              ...
              <a href="https://www.tiktok.com/@picnicpotential" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-gray-400 hover:text-gold transition-colors">
              ...
              <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-gold transition-colors">
              ...
              <a href={PINTEREST_URL} target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="text-gray-400 hover:text-gold transition-colors">
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-sm text-gray-300">
              ...
              <div className="pt-4">
                <Link
                  href="/request"
                  className="inline-block rounded-full bg-gold px-6 py-2.5 text-sm font-medium text-charcoal transition-colors hover:bg-gold-light"
                >
